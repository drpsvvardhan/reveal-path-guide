...
The Revision-2 assessment stands: retain the shell ("CIE v3.1 Interaction and Epistemic Substrate Demonstrator"), never present it as the compiler. What changes is that **every confirmed defect now maps to a named v3.2 law or release blocker** — the defect ledger becomes a conformance checklist rather than a judgment call:
