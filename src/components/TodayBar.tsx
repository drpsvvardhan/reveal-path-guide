...
const TodayBar: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-card border border-border/50 rounded-lg px-8 py-9 md:px-10 md:py-11">
        ...
        <div className="flex items-center gap-8 mb-8">
          <ProgressRing value={progressPct} size={88} strokeWidth={3}>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="flex items-center gap-3 px-4 py-3.5 rounded-md bg-background border border-border/40">
          ...
          {allActions.map((a, i) => {
            ...
            return (
              <motion.button
                ...
                className={`w-full bg-card border border-border/40 rounded-md px-5 py-4.5 flex items-center gap-4 text-left transition-all duration-150 ${
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className={`text-[14px] font-sans font-medium leading-snug ${done ? "line-through text-muted-foreground" : "text-foreground"}`}>
                    {a.title}
                  </p>
                  <p className="text-[12px] text-muted-foreground mt-1 leading-relaxed">{a.description.split(".")[0]}</p>
                </div>
              </motion.button>
            );
          })}
